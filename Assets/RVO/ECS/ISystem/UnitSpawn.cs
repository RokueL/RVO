    ...
    public void OnUpdate(ref SystemState state)
    {
        ...
        foreach (var entity in instances)
        {
            ...
            SpawnEntity(em,entity,spawnPos,new float3(2f,0f,20f),renderMeshArrayy,graphicSetting,
                MaterialType.E_Normal,MeshType.E_Capsule,arrayCount);
            em.AddComponentData(entity, new UnitATag());
            arrayCount++;
        }
        
        // 스폰 카운트 만큼 생성
        var instances2 = new NativeArray<Entity>(RvoData.SpawnCount, Allocator.Temp);
        ...
        foreach (var entity in instances2)
        {
            ...
            SpawnEntity(em,entity,spawnPos,new float3(2f,0f,-20f),renderMeshArrayy,graphicSetting,
                MaterialType.E_Normal2,MeshType.E_Capsule,arrayCount);
